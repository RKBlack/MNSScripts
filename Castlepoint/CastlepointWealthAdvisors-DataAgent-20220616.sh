...
if [ -z "https://rkblack.services-us6.cloudradial.com" ]; then
    echo "Please enter a valid service endpoint URL."
    exit 1
fi
if [ -z "https://rkblack.us.cloudradial.com" ]; then
...
echo ""
echo "Service Endpoint: https://rkblack.services-us6.cloudradial.com"
echo "Partner Url:      https://rkblack.us.cloudradial.com"
echo "Company Id:       19"
echo "Security Key:     "
echo ""
...
plutil -insert ProgramArguments -xml "<array><string>/Library/LaunchDaemons/CloudRadial.Mac.Agent/CloudRadial.Mac.Agent</string><string>https://rkblack.services-us6.cloudradial.com</string><string>https://rkblack.us.cloudradial.com</string><string>19</string><string></string></array>" /Library/LaunchDaemons/com.cloudradial.mac.agent.plist
